...
if __name__ == "__main__": 
    ...
    scipy.io.savemat('../Results/Stenosis2D_shear_results_%s.mat' %(time.strftime('%d_%m_%Y')),
    ...
    scipy.io.savemat('../Results/Stenosis2D_results_%s.mat' %(time.strftime('%d_%m_%Y')),
