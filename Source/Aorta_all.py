...
if __name__ == "__main__":
    ...
    data2 = scipy.io.loadmat('../Data/Aorta_narrow_nondim.mat')
    data3 = scipy.io.loadmat('../Data/Aorta_expand_nondim.mat')
    data4 = scipy.io.loadmat('../Data/Aorta_rough_nondim.mat')
