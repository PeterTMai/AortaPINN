...
class HFM(object):
    ...
    def __init__(self, t_data, x_data, y_data, z_data,
        ...
        [self.t_data, self.x_data, self.y_data, self.z_data, 
         self.u_data, self.v_data, self.w_data, self.p_data] = [t_data, x_data, y_data, z_data, u_data, v_data, w_data, p_data]
        ...
        [self.t_data_tf, self.x_data_tf, self.y_data_tf, self.z_data_tf,
         self.u_data_tf, self.v_data_tf, self.w_data_tf, self.p_data_tf] = [tf.compat.v1.placeholder(tf.float32, shape=[None, 1]) for _ in range(8)]
